pipeline {
    ...
    environment {
        ...
        ECR_REPO_NAME = 'web_app_final_devops_prac'
        ECR_REPO_URI = '661979762009.dkr.ecr.ap-south-2.amazonaws.com/web_app_final_devops_prac'
    }
                ...
                withCredentials([sshUserPrivateKey(credentialsId: 'ec2-ssh-key', keyFileVariable: 'SSH_KEY')]) {
                    sh """
                        ssh -o StrictHostKeyChecking=no -i \${SSH_KEY} ec2-user@${env.EC2_PUBLIC_IP} '
                            ...
                            # For simplicity, we assume the EC2 role is set up.
